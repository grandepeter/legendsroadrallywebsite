        ...
        <section className="bg-gradient-to-br from-black via-gray-900 to-gray-800 pt-20 pb-12 sm:pb-24 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1
                className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold text-white mb-6 leading-none whitespace-nowrap"
                style={{
                  fontFamily:
                    "var(--font-brice), ui-sans-serif, system-ui, -apple-system",
                  fontSize: "clamp(3rem, 3.25rem, 3.5rem)",
                }}
              >
                LEGENDS ROAD RALLY
              </h1>
